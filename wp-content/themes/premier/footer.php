			...
			<div class="section group">
				...
				<div class="col span_1_of_3">
					<?php if ( is_active_sidebar( 'center_column' ) && dynamic_sidebar('center_column') ) : else : ?>
						<div class="widget">
							<?php echo '<h4>' . __('Widget Ready', 'premier') . '</h4>'; ?>
							<?php echo '<p>' . __('This center column is widget ready! Add one in the admin panel.', 'premier') . '</p>'; ?>
						</div>     
					<?php endif; ?> 
				</div>
				...
				<div class="col span_1_of_3">
					<?php if ( is_active_sidebar( 'right_column' ) && dynamic_sidebar('right_column') ) : else : ?>
						<div class="widget">
							<?php echo '<h4>' . __('Widget Ready', 'premier') . '</h4>'; ?>
							<?php echo '<p>' . __('This right column is widget ready! Add one in the admin panel.', 'premier') . '</p>'; ?>
						</div>     
					<?php endif; ?> 
				</div>
        ...
        <?php if(! get_theme_mod('hide_copyright')): ?>
	        ...
	        <div class="site-info">
		        ...
		        <?php else: ?>
		            ...
		            <?php _e('Premier free WordPress shop theme','premier'); ?></a>
		            <?php echo __( 'Powered By WordPress ', 'premier' ); ?>
