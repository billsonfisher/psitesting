...
Class PMS_PayPal_Express_Pro {
    ...
    public function uninstall() {
        ...
        $active_gateways = array_diff( $pms_settings['payments']['active_pay_gates'], array( 'paypal_express', 'paypal_pro' ) );

        if( empty( $active_gateways ) )
            $active_gateways = array( 'paypal_standard' );

        $pms_settings['payments']['active_pay_gates'] = $active_gateways;
