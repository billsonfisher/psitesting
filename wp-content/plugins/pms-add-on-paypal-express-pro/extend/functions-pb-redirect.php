...
function pms_pb_paypal_express_register_redirect_plugins_loaded() {
    ...
    if( function_exists( 'wppb_build_redirect' ) ) {
         ...
         *
         */
        function pms_pb_paypal_express_add_payment_redirect_message() {
            ...
            echo '<p>' . __( 'You will soon be redirected to PayPal...', 'paid-member-subscriptions' ) . '</p>';

        }
        add_action( 'wppb_register_success', 'pms_pb_paypal_express_add_payment_redirect_message' );
