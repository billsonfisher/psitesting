...
<table id="pms-confirm-payment">
    <thead>
        <tr>
            <th><?php echo __( 'Subscription', 'paid-member-subscriptions' ); ?></th>
            <th><?php echo __( 'Price', 'paid-member-subscriptions' ); ?></th>
            <th><?php echo __( 'Recurring', 'paid-member-subscriptions' ); ?></th>
        </tr>
    </thead>
