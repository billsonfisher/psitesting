...
<?php __("Documentation", "paid-member-subscriptions"); ?>
...
<?php __("%s years", "paid-member-subscriptions"); ?>
<?php __(" after %s ", "paid-member-subscriptions"); ?>
...
<?php __("To allow users to register via Paid Member Subscriptions, you first must enable user registration. Go to %1$sNetwork Settings%2$s, and under Registration Settings make sure to check “User accounts may be registered”. %3$sDismiss%4$s", "paid-member-subscriptions"); ?>
<?php __("To allow users to register via Paid Member Subscriptions, you first must enable user registration. Go to %1$sSettings -> General%2$s tab, and under Membership make sure to check “Anyone can register”. %3$sDismiss%4$s", "paid-member-subscriptions"); ?>
<?php __("PayPal uses Instant Payment Notification (IPN) which %1$shas been updated for increased security%2$s and now requires you to install an SSL certificate and enable HTTPS on your site in order to function properly. %3$sDismiss%4$s", "paid-member-subscriptions"); ?>
...
<?php __("Maximum number of times this discount can be used. Enter 0 for unlimited.", "paid-member-subscriptions"); ?>
...
<?php __("Your PayPal API settings are missing. In order to make payments you will need to add your API credentials %1$s here %2$s.", "paid-member-subscriptions"); ?>
...
<?php __("Settings saved.", "paid-member-subscriptions"); ?>
...
<?php __("Capture more user information on the register form with the help of Profile Builder's custom user profile fields.", "paid-member-subscriptions"); ?>
...
<?php __("Check", "paid-member-subscriptions"); ?>
...
<?php __("By checking this option you will be able to use Paid Member Subscriptions with test accounts from your payment processors.", "paid-member-subscriptions"); ?>
...
<?php __("By checking this option the administrator email addresses from the field below wil receive email notifications.", "paid-member-subscriptions"); ?>
<?php __("Please add a list of email addresses, separated by comma, that you wish to receive emails for member subscription status changes.", "paid-member-subscriptions"); ?>
...
<?php __("This is not a valid subscription. %1$sBack to account%2$s", "paid-member-subscriptions"); ?>
...
<?php __("Go back to account", "paid-member-subscriptions"); ?>
...
<?php __("Checking any subscription plan will show this %s only to users that are subscribed those particular plans.", "paid-member-subscriptions"); ?>
