...
class WpProQuiz_View_FrontQuiz extends WpProQuiz_View_View
{
    ...
    private function showResultBox($result, $questionCount)
    {
        ...
        <div style="display: none;" class="wpProQuiz_results">
            ...
            <h4 class="wpProQuiz_header"><?php _e('', 'wp-pro-quiz'); ?></h4>
			...
			<div class="wpProQuiz_normdistdescription">
				<p>
			...
			<div class="wpProQuiz_resultsprinttext">
				<p>
					<?php _e('<p>PLEASE NOTE: You will not be able to access this page once you navigate away. If you wish to retain a copy of this report <a href="javascript:window.print()">please print this page</a>.</p>'); ?>
				</p>
			</div>
            <?php
            ...
            <div style="margin: 10px 0px;">
                ...
                if (!$this->quiz->isBtnViewQuestionHidden()) { ?>
                    <input class="wpProQuiz_button" type="button" name="reShowQuestion"
                           value="<?php _e('View Questions and Coaching Strategies', 'wp-pro-quiz'); ?>">
                <?php } ?>
